...
;(function() {
  ...
  function _parseCM(strIn) {
    let num = _parseM(strIn);
    if (typeof num === 'number') {
      return num * s_siPrefixInv.cm;
    }
    return num[0] * s_siPrefixInv.cm;
  }

  function _parseMM(strIn) {
    let num = _parseM(strIn);
    if (typeof num === 'number') {
      return num * s_siPrefixInv.mm;
    }
    return num[0] * s_siPrefixInv.mm;
  }
